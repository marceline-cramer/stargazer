...
/// Defines a function value type for a backend.
pub trait Function: Backend {
    type Function<'a, I: 'a, O: 'a>;
}

/// Creates function values from Rust functions.
pub trait BuildFunction: Function {
...
/// Runs a built function value with runtime Rust data.
pub trait RunFunction: Function {
